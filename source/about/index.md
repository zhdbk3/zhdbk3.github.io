...
- `source/_posts/` 下的内容（即博客文章）与 `source/about/index.md`（即关于页面，即本页面）默认采用 [CC NC-BY-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) 许可证。特别地，对于文章中的代码块，默认采用 [MIT](https://github.com/zhdbk3/zhdbk3.github.io/blob/main/LICENSE) 许可证。
- 其他部分（如网站代码等）均默认采用 [MIT](https://github.com/zhdbk3/zhdbk3.github.io/blob/main/LICENSE) 许可证。
- 有特别声明使用其他许可证的，使用声明的许可证。
- 引用的其他人的资源（如背景图片等），版权归原作者所有。

如果哪里侵犯到了您的权利，请联系我删除或调整相关内容。

## 代码与资源的来源的声明与指路

本项目学习自[《Hexo + Butterfly 个人网站效果展示》](https://www.bilibili.com/video/BV1sK411Q7S7)及其相关视频，并直接使用了里面的一些代码，开源仓库：[fomalhaut1998/hexo-theme-Fomalhaut](https://github.com/fomalhaut1998/hexo-theme-Fomalhaut)。

背景图片（`source/img/bg/`）原始出处：

|          文件          |                                            作者                                             |                                                                      链接                                                                       |
| :--------------------: | :-----------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------: |
|    `mahiro/1.avif`     |        [ElPelo](https://steamcommunity.com/id/ElPelo/myworkshopfiles/?appid=431960)         |                          [绪山真寻 Oyama Mahiro 4K](https://steamcommunity.com/sharedfiles/filedetails/?id=3012053777)                          |
...
- [图片汇总 | 可能过分的小窝](https://blog.wangyupwp.cn/image)
- [《【Wallpaper Engine】壁纸推荐 绪山真寻篇》](https://www.bilibili.com/video/BV19H4y1c7Ko)
