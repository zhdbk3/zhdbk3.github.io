const MY_BIRTH_TIME = new Date('2009-5-13 17:13');
...
document.getElementById('footer-wrap').innerHTML +=
    '<div>猫猫已坚强地生活了 <span id="my-runtime"></span></div>' +
    '<div>本站已运行 <span id="website-runtime"></span></div>' +
    '<i>每一个不曾起舞的日子，都是对生命的辜负。</i>';

// 每秒刷新
setInterval(() => {
    document.getElementById('my-runtime').innerText = getFormattedInterval(MY_BIRTH_TIME);
